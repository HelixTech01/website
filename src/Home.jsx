      ...
      <div class="wrapper sidemenu-wrapper" id="wrapper">
        ...
        <div className="hsshshsh mobileHeader">
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
              <Link class="navbar-brand" to="/helix/">
                <img
                  src={`${process.env.PUBLIC_URL}/images/logo/logo.png`}
                  alt=""
                />
        ...
        <div class="sidemenu-wrapper-body">
          ...
          <div class="banner-area">
            <div
              class="single-banner bg-image-9 fullscreen bg-parallax"
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-9">
                    <div class="single-banner-content">
                      ...
                      <Link
                        to="/helix/About_us"
                        class="cr-btn cr-btn-lg cr-btn-round"
                      >
          ...
          <main class="page-content">
            <section
              id="feature-area"
              class="feature-area section-padding-lg bg-grey"
            >
              <div class="container">
                <div class="row">
                        ...
                        >
                          <div class="row">
                            ...
                            <div class="col-lg-7 col-12">
                              <div class="section-title text-center mt-5 pl-0">
                                ...
                                <a href="javascript:;" class="cr-btn">
                                  ...
                                  <b class="top: 167.406px; left: 172.5px;"></b>
                                </a>
                              </div>
                            </div>
                          </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-body p-5">
                ...
                <div class="mb-3">
                  <label for="emailControlInput3" class="form-label">
                    Password
                  </label>
                  <input
                    type="password"
